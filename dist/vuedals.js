...
/***/
function(module,exports,__webpack_require__){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0});var _assign=__webpack_require__(29),_assign2=_interopRequireDefault(_assign),_bus=__webpack_require__(1),_bus2=_interopRequireDefault(_bus);exports.default={name:"vuedals",created:function(){var _this=this;_bus2.default.$on("new",function(data){var defaults={title:null,dismisable:!0,name:"",size:"md"},options=(0,_assign2.default)(defaults,data);_this.vuedals.push(options),_bus2.default.$emit("opened",{index:_this.vuedals.length-1,data:data})}),_bus2.default.$on("close",function(_){return _this.close()})},data:function(){return{vuedals:[]}},methods:{close:function(){var index=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return index||(index=this.vuedals.length-1),_bus2.default.$emit("closed",{index:index,data:this.vuedals[index]}),0===index&&_bus2.default.$emit("destroyed"),index?void(index!==-1&&this.vuedals.splice(index,1)):void this.vuedals.pop()},getCssClasses:function(index){var vuedal=this.vuedals[index],classNames=vuedal.name+" "+vuedal.size;return index<this.$last&&(classNames+=" disabled"),classNames}},computed:{$last:function(){return this.vuedals.length-1}}}},/* 29 */
/***/
